...
import backend.src.py.main_functions.dream_on as dream_on
...
def clicked(button, MainWindow, self):
        ...
        if button == 'input_folder':
                ...
                dir = "./"
                input_file = QtWidgets.QFileDialog.getOpenFileName(None, "Select picture...", dir, filter="Images (*.png *.jpg)")
                ...
                global input_frames_amount
                input_frames_amount = self.input_frames_amount.toPlainText()
                ...
                if initiate_generate == True:
                        ...
                        print('Frames amount: {}'.format(input_frames_amount))
                        
                        # Progress bar
                        self.completed = 0
                        self.progress.setValue(self.completed)
                        
                        dream_on.start_dream_on(input_layer, input_iterations, input_recursive_level, input_frames_amount, input_file, output_folder, self)
        ...
        # Random generate button
                ...
                random_frames_amount = random.randint(5,50)
                ...
                self.input_frames_amount.setPlainText('{}'.format(random_frames_amount))
