...
import backend.src.py.main_functions.dream_images_to_video as dream_images_to_video
import backend.src.py.windows.help_window as help_window
window = "images_to_video"
...
def clicked(button, MainWindow, self):
        ...
        if button == 'input_folder':
                ...
                global fps
                fps = self.input_fps.toPlainText()
                input_layer = ""
                input_iterations = ""
                input_recursive_level = ""
                ...
                if initiate_generate == True:
                        ...
                        dream_images_to_video.start_video(input_file, output_folder, fps, self)
...
def start_images_to_video(MainWindow):
    import sys
